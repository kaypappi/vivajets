...
const content: Record<string, { title: string; paragraphs: string[]; images: { src: string; alt: string }[] }> = {
  ...
  "challenger-604": {
    ...
    images: [
      { src: "https://res.cloudinary.com/dljgzevaj/image/upload/v1757402871/d54f8bd062c9d0c837f65f91e91f244ea6ac8c50_o1j8bq.jpg", alt: "Challenger 604 side view" },
      ...
      { src: "https://res.cloudinary.com/dljgzevaj/image/upload/v1757402943/1ad3b63858c442914d7ecf66d258355cf835a6cf_l79tpj.jpg", alt: "Challenger 604 engine" },
      ...
      { src: "https://res.cloudinary.com/dljgzevaj/image/upload/v1757403059/381c9ef8fd9f58b6a6aba3c100cc5ef80413546a_dxoy9u.jpg", alt: "Challenger 604 engine" },
