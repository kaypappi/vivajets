...
const TestimonialMobileCard: React.FC<TestimonialMobileCardProps> = ({
  ...
  return (
    <div className={` w-full text-white ${className}`}>
      <div className="card-top flex p-4 gap-2 bg-meteor/80 border-b-2 border-dashed rounded-md max-w-[18.5rem]">
      ...
      <div className="card-bottom rounded-md bg-meteor/80 p-4 max-w-[18.5rem]">
        <p className="p">
            {slide.testimony}
        </p>
      </div>
